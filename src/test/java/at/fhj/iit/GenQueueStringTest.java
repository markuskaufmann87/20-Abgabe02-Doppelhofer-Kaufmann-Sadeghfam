...
public class GenQueueStringTest {
     ...
     *
     * @throws MaxSizeException thrown if maxSize of queue is reached!
     ...
     *
     * @throws NoSuchElementException thrown because {@link GenQueueIntegerTest#queue1} is empty
